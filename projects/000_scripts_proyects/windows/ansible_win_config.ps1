...
$usuario = "ansible"
$contraseña = Read-Host -Prompt "Ingrese la contraseña"

# Crear el nuevo usuario
$crearUsuario = New-LocalUser -Name $usuario -Password $contraseña -PasswordNeverExpires:$true -UserMayNotChangePassword:$true -AccountNeverExpires:$true -Description "Usuario para fines administrativos"
